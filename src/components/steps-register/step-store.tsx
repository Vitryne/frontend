        ...
        <div>
            ...
            <form className="mt-10 grid grid-cols-12 gap-4">
                <div className="col-span-12">
                    <Input title="Nome da loja *" placeholder="Atelier Norte" type="text"/>
                </div>
                ...
                <div className="col-span-12">
                    <Input title="Razão social *" placeholder="Atelier Norte Comércio de Moda LTDA" type="text"/>
                </div>

                <div className="col-span-12">
                    <Input title="Descrição da loja" placeholder="Moda contemporânea em peças atemporais, com produção autoral em Maringá." type="text"/>
                </div>
                ...
                <div className="col-span-12">
                    <Input title="Telefone de contato *" placeholder="(11) 99421-8842" type="tel"/>
                </div>
            </form>
            ...
            <div className="flex justify-end pt-8">
                ...
                >
                    <p className="text-[1rem]">Proximo</p>
